...
void main() {
	...
	`}class h_ extends ji{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new r_(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const w1={[L0]:"Linear",[I0]:"Reinhard",[D0]:"Cineon",[N0]:"ACESFilmic",[F0]:"AgX",[O0]:"Neutral",[U0]:"Custom"};function A1(o,e){const t=w1[e];return t===void 0?(Je("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Sc=new j;function b1(){Mt.getLuminanceCoefficients(Sc);const o=Sc.x.toFixed(4),e=Sc.y.toFixed(4),t=Sc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+S);const L=R+y+c,C=R+S+f,N=c0(s,s.VERTEX_SHADER,L),U=c0(s,s.FRAGMENT_SHADER,C);s.attachShader(A,N),s.attachShader(A,U),t.index0AttributeName!==void 0?s.bindAttribLocation(A,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(A,0,"position"),s.linkProgram(A);function k(O){if(o.debug.checkShaderErrors){const J=s.getProgramInfoLog(A)||"",K=s.getShaderInfoLog(N)||"",ae=s.getShaderInfoLog(U)||"",Q=J.trim(),te=K.trim(),W=ae.trim();let $=!0,oe=!0;if(s.getProgramParameter(A,s.LINK_STATUS)===!1)if($=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(s,A,N,U);else{const ce=f0(s,N,"vertex"),F=f0(s,U,"fragment");rt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(A,s.VALIDATE_STATUS)+`
...
}`,aw=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],lw=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],x0=new mt,Sa=new j,sh=new j;function cw(o,e,t){let i=new Md;const s=new lt,a=new lt,c=new Wt,f=new qy,h=new Ky,d={},g=t.maxTextureSize,_={[vr]:Wn,[Wn]:vr,[Gi]:Gi},m=new Ki({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new lt},radius:{value:4}},vertexShader:sw,fragmentShader:ow}),x=m.clone();x.defines.HORIZONTAL_PASS=1;const M=new di;M.setAttribute("position",new In(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new Xn(M,m),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ec;let S=this.type;this.render=function(U,k,w){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||U.length===0)return;this.type===C0&&(Je("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ec);const P=o.getRenderTarget(),le=o.getActiveCubeFace(),O=o.getActiveMipmapLevel(),J=o.state;J.setBlending(gr),J.buffers.depth.getReversed()===!0?J.buffers.color.setClear(0,0,0,0):J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const K=S!==this.type;K&&k.traverse(function(ae){ae.material&&(Array.isArray(ae.material)?ae.material.forEach(Q=>Q.needsUpdate=!0):ae.material.needsUpdate=!0)});for(let ae=0,Q=U.length;ae<Q;ae++){const te=U[ae],W=te.shadow;if(W===void 0){Je("WebGLShadowMap:",te,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;s.copy(W.mapSize);const $=W.getFrameExtents();s.multiply($),a.copy(W.mapSize),(s.x>g||s.y>g)&&(s.x>g&&(a.x=Math.floor(g/$.x),s.x=a.x*$.x,W.mapSize.x=a.x),s.y>g&&(a.y=Math.floor(g/$.y),s.y=a.y*$.y,W.mapSize.y=a.y));const oe=o.state.buffers.depth.getReversed();if(W.camera._reversedDepth=oe,W.map===null||K===!0){if(W.map!==null&&(W.map.depthTexture!==null&&(W.map.depthTexture.dispose(),W.map.depthTexture=null),W.map.dispose()),this.type===Ea){if(te.isPointLight){Je("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}W.map=new ji(s.x,s.y,{format:Mo,type:xr,minFilter:cn,magFilter:cn,generateMipmaps:!1}),W.map.texture.name=te.name+".shadowMap",W.map.depthTexture=new Ua(s.x,s.y,fi),W.map.depthTexture.name=te.name+".shadowMapDepth",W.map.depthTexture.format=yr,W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=ln,W.map.depthTexture.magFilter=ln}else te.isPointLight?(W.map=new h_(s.x),W.map.depthTexture=new Vy(s.x,Yi)):(W.map=new ji(s.x,s.y),W.map.depthTexture=new Ua(s.x,s.y,Yi)),W.map.depthTexture.name=te.name+".shadowMap",W.map.depthTexture.format=yr,this.type===Ec?(W.map.depthTexture.compareFunction=oe?gd:md,W.map.depthTexture.minFilter=cn,W.map.depthTexture.magFilter=cn):(W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=ln,W.map.depthTexture.magFilter=ln);W.camera.updateProjectionMatrix()}const ce=W.map.isWebGLCubeRenderTarget?6:1;for(let F=0;F<ce;F++){if(W.map.isWebGLCubeRenderTarget)o.setRenderTarget(W.map,F),o.clear();else{F===0&&(o.setRenderTarget(W.map),o.clear());const Y=W.getViewport(F);c.set(a.x*Y.x,a.y*Y.y,a.x*Y.z,a.y*Y.w),J.viewport(c)}if(te.isPointLight){const Y=W.camera,Ae=W.matrix,We=te.distance||Y.far;We!==Y.far&&(Y.far=We,Y.updateProjectionMatrix()),Sa.setFromMatrixPosition(te.matrixWorld),Y.position.copy(Sa),sh.copy(Y.position),sh.add(aw[F]),Y.up.copy(lw[F]),Y.lookAt(sh),Y.updateMatrixWorld(),Ae.makeTranslation(-Sa.x,-Sa.y,-Sa.z),x0.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),W._frustum.setFromProjectionMatrix(x0,Y.coordinateSystem,Y.reversedDepth)}else W.updateMatrices(te);i=W.getFrustum(),C(k,w,W.camera,te,this.type)}W.isPointLightShadow!==!0&&this.type===Ea&&R(W,w),W.needsUpdate=!1}S=this.type,y.needsUpdate=!1,o.setRenderTarget(P,le,O)};function R(U,k){const w=e.update(A);m.defines.VSM_SAMPLES!==U.blurSamples&&(m.defines.VSM_SAMPLES=U.blurSamples,x.defines.VSM_SAMPLES=U.blurSamples,m.needsUpdate=!0,x.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new ji(s.x,s.y,{format:Mo,type:xr})),m.uniforms.shadow_pass.value=U.map.depthTexture,m.uniforms.resolution.value=U.mapSize,m.uniforms.radius.value=U.radius,o.setRenderTarget(U.mapPass),o.clear(),o.renderBufferDirect(k,null,w,m,A,null),x.uniforms.shadow_pass.value=U.mapPass.texture,x.uniforms.resolution.value=U.mapSize,x.uniforms.radius.value=U.radius,o.setRenderTarget(U.map),o.clear(),o.renderBufferDirect(k,null,w,x,A,null)}function L(U,k,w,P){let le=null;const O=w.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(O!==void 0)le=O;else if(le=w.isPointLight===!0?h:f,o.localClippingEnabled&&k.clipShadows===!0&&Array.isArray(k.clippingPlanes)&&k.clippingPlanes.length!==0||k.displacementMap&&k.displacementScale!==0||k.alphaMap&&k.alphaTest>0||k.map&&k.alphaTest>0||k.alphaToCoverage===!0){const J=le.uuid,K=k.uuid;let ae=d[J];ae===void 0&&(ae={},d[J]=ae);let Q=ae[K];Q===void 0&&(Q=le.clone(),ae[K]=Q,k.addEventListener("dispose",N)),le=Q}if(le.visible=k.visible,le.wireframe=k.wireframe,P===Ea?le.side=k.shadowSide!==null?k.shadowSide:k.side:le.side=k.shadowSide!==null?k.shadowSide:_[k.side],le.alphaMap=k.alphaMap,le.alphaTest=k.alphaToCoverage===!0?.5:k.alphaTest,le.map=k.map,le.clipShadows=k.clipShadows,le.clippingPlanes=k.clippingPlanes,le.clipIntersection=k.clipIntersection,le.displacementMap=k.displacementMap,le.displacementScale=k.displacementScale,le.displacementBias=k.displacementBias,le.wireframeLinewidth=k.wireframeLinewidth,le.linewidth=k.linewidth,w.isPointLight===!0&&le.isMeshDistanceMaterial===!0){const J=o.properties.get(le);J.light=w}return le}function C(U,k,w,P,le){if(U.visible===!1)return;if(U.layers.test(k.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&le===Ea)&&(!U.frustumCulled||i.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,U.matrixWorld);const K=e.update(U),ae=U.material;if(Array.isArray(ae)){const Q=K.groups;for(let te=0,W=Q.length;te<W;te++){const $=Q[te],oe=ae[$.materialIndex];if(oe&&oe.visible){const ce=L(U,oe,P,le);U.onBeforeShadow(o,U,k,w,K,ce,$),o.renderBufferDirect(w,null,K,ce,U,$),U.onAfterShadow(o,U,k,w,K,ce,$)}}}else if(ae.visible){const Q=L(U,ae,P,le);U.onBeforeShadow(o,U,k,w,K,Q,null),o.renderBufferDirect(w,null,K,Q,U,null),U.onAfterShadow(o,U,k,w,K,Q,null)}}const J=U.children;for(let K=0,ae=J.length;K<ae;K++)C(J[K],k,w,P,le)}function N(U){U.target.removeEventListener("dispose",N);for(const w in d){const P=d[w],le=U.target.uuid;le in P&&(P[le].dispose(),delete P[le])}}}function uw(o,e){function t(){let V=!1;const we=new Wt;let Se=null;const Le=new Wt(0,0,0,0);return{setMask:function(ye){Se!==ye&&!V&&(o.colorMask(ye,ye,ye,ye),Se=ye)},setLocked:function(ye){V=ye},setClear:function(ye,fe,Be,st,It){It===!0&&(ye*=st,fe*=st,Be*=st),we.set(ye,fe,Be,st),Le.equals(we)===!1&&(o.clearColor(ye,fe,Be,st),Le.copy(we))},reset:function(){V=!1,Se=null,Le.set(-1,0,0,0)}}}function i(){let V=!1,we=!1,Se=null,Le=null,ye=null;return{setReversed:function(fe){if(we!==fe){const Be=e.get("EXT_clip_control");fe?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT),we=fe;const st=ye;ye=null,this.setClear(st)}},getReversed:function(){return we},setTest:function(fe){fe?pe(o.DEPTH_TEST):de(o.DEPTH_TEST)},setMask:function(fe){Se!==fe&&!V&&(o.depthMask(fe),Se=fe)},setFunc:function(fe){if(we&&(fe=Yx[fe]),Le!==fe){switch(fe){case hh:o.depthFunc(o.NEVER);break;case dh:o.depthFunc(o.ALWAYS);break;case ph:o.depthFunc(o.LESS);break;case xo:o.depthFunc(o.LEQUAL);break;case mh:o.depthFunc(o.EQUAL);break;case gh:o.depthFunc(o.GEQUAL);break;case _h:o.depthFunc(o.GREATER);break;case vh:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Le=fe}},setLocked:function(fe){V=fe},setClear:function(fe){ye!==fe&&(ye=fe,we&&(fe=1-fe),o.clearDepth(fe))},reset:function(){V=!1,Se=null,Le=null,ye=null,we=!1}}}function s(){let V=!1,we=null,Se=null,Le=null,ye=null,fe=null,Be=null,st=null,It=null;return{setTest:function(At){V||(At?pe(o.STENCIL_TEST):de(o.STENCIL_TEST))},setMask:function(At){we!==At&&!V&&(o.stencilMask(At),we=At)},setFunc:function(At,ei,An){(Se!==At||Le!==ei||ye!==An)&&(o.stencilFunc(At,ei,An),Se=At,Le=ei,ye=An)},setOp:function(At,ei,An){(fe!==At||Be!==ei||st!==An)&&(o.stencilOp(At,ei,An),fe=At,Be=ei,st=An)},setLocked:function(At){V=At},setClear:function(At){It!==At&&(o.clearStencil(At),It=At)},reset:function(){V=!1,we=null,Se=null,Le=null,ye=null,fe=null,Be=null,st=null,It=null}}}const a=new t,c=new i,f=new s,h=new WeakMap,d=new WeakMap;let g={},_={},m=new WeakMap,x=[],M=null,A=!1,y=null,S=null,R=null,L=null,C=null,N=null,U=null,k=new ct(0,0,0),w=0,P=!1,le=null,O=null,J=null,K=null,ae=null;const Q=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,W=0;const $=o.getParameter(o.VERSION);$.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec($)[1]),te=W>=1):$.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),te=W>=2);let oe=null,ce={};const F=o.getParameter(o.SCISSOR_BOX),Y=o.getParameter(o.VIEWPORT),Ae=new Wt().fromArray(F),We=new Wt().fromArray(Y);function $e(V,we,Se,Le){const ye=new Uint8Array(4),fe=o.createTexture();o.bindTexture(V,fe),o.texParameteri(V,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(V,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Be=0;Be<Se;Be++)V===o.TEXTURE_3D||V===o.TEXTURE_2D_ARRAY?o.texImage3D(we,0,o.RGBA,1,1,Le,0,o.RGBA,o.UNSIGNED_BYTE,ye):o.texImage2D(we+Be,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,ye);return fe}const ie={};ie[o.TEXTURE_2D]=$e(o.TEXTURE_2D,o.TEXTURE_2D,1),ie[o.TEXTURE_CUBE_MAP]=$e(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),ie[o.TEXTURE_2D_ARRAY]=$e(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),ie[o.TEXTURE_3D]=$e(o.TEXTURE_3D,o.TEXTURE_3D,1,1),a.setClear(0,0,0,1),c.setClear(1),f.setClear(0),pe(o.DEPTH_TEST),c.setFunc(xo),ft(!1),Vt(ng),pe(o.CULL_FACE),Tt(gr);function pe(V){g[V]!==!0&&(o.enable(V),g[V]=!0)}function de(V){g[V]!==!1&&(o.disable(V),g[V]=!1)}function Ue(V,we){return _[V]!==we?(o.bindFramebuffer(V,we),_[V]=we,V===o.DRAW_FRAMEBUFFER&&(_[o.FRAMEBUFFER]=we),V===o.FRAMEBUFFER&&(_[o.DRAW_FRAMEBUFFER]=we),!0):!1}function Ve(V,we){let Se=x,Le=!1;if(V){Se=m.get(we),Se===void 0&&(Se=[],m.set(we,Se));const ye=V.textures;if(Se.length!==ye.length||Se[0]!==o.COLOR_ATTACHMENT0){for(let fe=0,Be=ye.length;fe<Be;fe++)Se[fe]=o.COLOR_ATTACHMENT0+fe;Se.length=ye.length,Le=!0}}else Se[0]!==o.BACK&&(Se[0]=o.BACK,Le=!0);Le&&o.drawBuffers(Se)}function nt(V){return M!==V?(o.useProgram(V),M=V,!0):!1}const Zt={[ys]:o.FUNC_ADD,[dx]:o.FUNC_SUBTRACT,[px]:o.FUNC_REVERSE_SUBTRACT};Zt[mx]=o.MIN,Zt[gx]=o.MAX;const _t={[_x]:o.ZERO,[vx]:o.ONE,[xx]:o.SRC_COLOR,[uh]:o.SRC_ALPHA,[wx]:o.SRC_ALPHA_SATURATE,[Ex]:o.DST_COLOR,[Sx]:o.DST_ALPHA,[yx]:o.ONE_MINUS_SRC_COLOR,[fh]:o.ONE_MINUS_SRC_ALPHA,[Tx]:o.ONE_MINUS_DST_COLOR,[Mx]:o.ONE_MINUS_DST_ALPHA,[Ax]:o.CONSTANT_COLOR,[bx]:o.ONE_MINUS_CONSTANT_COLOR,[Rx]:o.CONSTANT_ALPHA,[Cx]:o.ONE_MINUS_CONSTANT_ALPHA};function Tt(V,we,Se,Le,ye,fe,Be,st,It,At){if(V===gr){A===!0&&(de(o.BLEND),A=!1);return}if(A===!1&&(pe(o.BLEND),A=!0),V!==hx){if(V!==y||At!==P){if((S!==ys||C!==ys)&&(o.blendEquation(o.FUNC_ADD),S=ys,C=ys),At)switch(V){case go:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case ig:o.blendFunc(o.ONE,o.ONE);break;case rg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case sg:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:rt("WebGLState: Invalid blending: ",V);break}else switch(V){case go:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case ig:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case rg:rt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case sg:rt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rt("WebGLState: Invalid blending: ",V);break}R=null,L=null,N=null,U=null,k.set(0,0,0),w=0,y=V,P=At}return}ye=ye||we,fe=fe||Se,Be=Be||Le,(we!==S||ye!==C)&&(o.blendEquationSeparate(Zt[we],Zt[ye]),S=we,C=ye),(Se!==R||Le!==L||fe!==N||Be!==U)&&(o.blendFuncSeparate(_t[Se],_t[Le],_t[fe],_t[Be]),R=Se,L=Le,N=fe,U=Be),(st.equals(k)===!1||It!==w)&&(o.blendColor(st.r,st.g,st.b,It),k.copy(st),w=It),y=V,P=!1}function Pt(V,we){V.side===Gi?de(o.CULL_FACE):pe(o.CULL_FACE);let Se=V.side===Wn;we&&(Se=!Se),ft(Se),V.blending===go&&V.transparent===!1?Tt(gr):Tt(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),c.setFunc(V.depthFunc),c.setTest(V.depthTest),c.setMask(V.depthWrite),a.setMask(V.colorWrite);const Le=V.stencilWrite;f.setTest(Le),Le&&(f.setMask(V.stencilWriteMask),f.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),f.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),Xt(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?pe(o.SAMPLE_ALPHA_TO_COVERAGE):de(o.SAMPLE_ALPHA_TO_COVERAGE)}function ft(V){le!==V&&(V?o.frontFace(o.CW):o.frontFace(o.CCW),le=V)}function Vt(V){V!==ux?(pe(o.CULL_FACE),V!==O&&(V===ng?o.cullFace(o.BACK):V===fx?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):de(o.CULL_FACE),O=V}function z(V){V!==J&&(te&&o.lineWidth(V),J=V)}function Xt(V,we,Se){V?(pe(o.POLYGON_OFFSET_FILL),(K!==we||ae!==Se)&&(K=we,ae=Se,c.getReversed()&&(we=-we),o.polygonOffset(we,Se))):de(o.POLYGON_OFFSET_FILL)}function yt(V){V?pe(o.SCISSOR_TEST):de(o.SCISSOR_TEST)}function wt(V){V===void 0&&(V=o.TEXTURE0+Q-1),oe!==V&&(o.activeTexture(V),oe=V)}function He(V,we,Se){Se===void 0&&(oe===null?Se=o.TEXTURE0+Q-1:Se=oe);let Le=ce[Se];Le===void 0&&(Le={type:void 0,texture:void 0},ce[Se]=Le),(Le.type!==V||Le.texture!==we)&&(oe!==Se&&(o.activeTexture(Se),oe=Se),o.bindTexture(V,we||ie[V]),Le.type=V,Le.texture=we)}function I(){const V=ce[oe];V!==void 0&&V.type!==void 0&&(o.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function E(){try{o.compressedTexImage2D(...arguments)}catch(V){rt("WebGLState:",V)}}function G(){try{o.compressedTexImage3D(...arguments)}catch(V){rt("WebGLState:",V)}}function he(){try{o.texSubImage2D(...arguments)}catch(V){rt("WebGLState:",V)}}function me(){try{o.texSubImage3D(...arguments)}catch(V){rt("WebGLState:",V)}}function ue(){try{o.compressedTexSubImage2D(...arguments)}catch(V){rt("WebGLState:",V)}}function Oe(){try{o.compressedTexSubImage3D(...arguments)}catch(V){rt("WebGLState:",V)}}function Te(){try{o.texStorage2D(...arguments)}catch(V){rt("WebGLState:",V)}}function Ye(){try{o.texStorage3D(...arguments)}catch(V){rt("WebGLState:",V)}}function it(){try{o.texImage2D(...arguments)}catch(V){rt("WebGLState:",V)}}function xe(){try{o.texImage3D(...arguments)}catch(V){rt("WebGLState:",V)}}function Ee(V){Ae.equals(V)===!1&&(o.scissor(V.x,V.y,V.z,V.w),Ae.copy(V))}function Ge(V){We.equals(V)===!1&&(o.viewport(V.x,V.y,V.z,V.w),We.copy(V))}function ke(V,we){let Se=d.get(we);Se===void 0&&(Se=new WeakMap,d.set(we,Se));let Le=Se.get(V);Le===void 0&&(Le=o.getUniformBlockIndex(we,V.name),Se.set(V,Le))}function Pe(V,we){const Le=d.get(we).get(V);h.get(we)!==Le&&(o.uniformBlockBinding(we,Le,V.__bindingPointIndex),h.set(we,Le))}function ut(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),c.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),g={},oe=null,ce={},_={},m=new WeakMap,x=[],M=null,A=!1,y=null,S=null,R=null,L=null,C=null,N=null,U=null,k=new ct(0,0,0),w=0,P=!1,le=null,O=null,J=null,K=null,ae=null,Ae.set(0,0,o.canvas.width,o.canvas.height),We.set(0,0,o.canvas.width,o.canvas.height),a.reset(),c.reset(),f.reset()}return{buffers:{color:a,depth:c,stencil:f},enable:pe,disable:de,bindFramebuffer:Ue,drawBuffers:Ve,useProgram:nt,setBlending:Tt,setMaterial:Pt,setFlipSided:ft,setCullFace:Vt,setLineWidth:z,setPolygonOffset:Xt,setScissorTest:yt,activeTexture:wt,bindTexture:He,unbindTexture:I,compressedTexImage2D:E,compressedTexImage3D:G,texImage2D:it,texImage3D:xe,updateUBOMapping:ke,uniformBlockBinding:Pe,texStorage2D:Te,texStorage3D:Ye,texSubImage2D:he,texSubImage3D:me,compressedTexSubImage2D:ue,compressedTexSubImage3D:Oe,scissor:Ee,viewport:Ge,reset:ut}}function fw(o,e,t,i,s,a,c){const f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),d=new lt,g=new WeakMap;let _;const m=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(I,E){return x?new OffscreenCanvas(I,E):Na("canvas")}function A(I,E,G){let he=1;const me=He(I);if((me.width>G||me.height>G)&&(he=G/Math.max(me.width,me.height)),he<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const ue=Math.floor(he*me.width),Oe=Math.floor(he*me.height);_===void 0&&(_=M(ue,Oe));const Te=E?M(ue,Oe):_;return Te.width=ue,Te.height=Oe,Te.getContext("2d").drawImage(I,0,0,ue,Oe),Je("WebGLRenderer: Texture has been resized from ("+me.width+"x"+me.height+") to ("+ue+"x"+Oe+")."),Te}else return"data"in I&&Je("WebGLRenderer: Image in DataTexture is too big ("+me.width+"x"+me.height+")."),I;return I}function y(I){return I.generateMipmaps}function S(I){o.generateMipmap(I)}function R(I){return I.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?o.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(I,E,G,he,me=!1){if(I!==null){if(o[I]!==void 0)return o[I];Je("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ue=E;if(E===o.RED&&(G===o.FLOAT&&(ue=o.R32F),G===o.HALF_FLOAT&&(ue=o.R16F),G===o.UNSIGNED_BYTE&&(ue=o.R8)),E===o.RED_INTEGER&&(G===o.UNSIGNED_BYTE&&(ue=o.R8UI),G===o.UNSIGNED_SHORT&&(ue=o.R16UI),G===o.UNSIGNED_INT&&(ue=o.R32UI),G===o.BYTE&&(ue=o.R8I),G===o.SHORT&&(ue=o.R16I),G===o.INT&&(ue=o.R32I)),E===o.RG&&(G===o.FLOAT&&(ue=o.RG32F),G===o.HALF_FLOAT&&(ue=o.RG16F),G===o.UNSIGNED_BYTE&&(ue=o.RG8)),E===o.RG_INTEGER&&(G===o.UNSIGNED_BYTE&&(ue=o.RG8UI),G===o.UNSIGNED_SHORT&&(ue=o.RG16UI),G===o.UNSIGNED_INT&&(ue=o.RG32UI),G===o.BYTE&&(ue=o.RG8I),G===o.SHORT&&(ue=o.RG16I),G===o.INT&&(ue=o.RG32I)),E===o.RGB_INTEGER&&(G===o.UNSIGNED_BYTE&&(ue=o.RGB8UI),G===o.UNSIGNED_SHORT&&(ue=o.RGB16UI),G===o.UNSIGNED_INT&&(ue=o.RGB32UI),G===o.BYTE&&(ue=o.RGB8I),G===o.SHORT&&(ue=o.RGB16I),G===o.INT&&(ue=o.RGB32I)),E===o.RGBA_INTEGER&&(G===o.UNSIGNED_BYTE&&(ue=o.RGBA8UI),G===o.UNSIGNED_SHORT&&(ue=o.RGBA16UI),G===o.UNSIGNED_INT&&(ue=o.RGBA32UI),G===o.BYTE&&(ue=o.RGBA8I),G===o.SHORT&&(ue=o.RGBA16I),G===o.INT&&(ue=o.RGBA32I)),E===o.RGB&&(G===o.UNSIGNED_INT_5_9_9_9_REV&&(ue=o.RGB9_E5),G===o.UNSIGNED_INT_10F_11F_11F_REV&&(ue=o.R11F_G11F_B10F)),E===o.RGBA){const Oe=me?Lc:Mt.getTransfer(he);G===o.FLOAT&&(ue=o.RGBA32F),G===o.HALF_FLOAT&&(ue=o.RGBA16F),G===o.UNSIGNED_BYTE&&(ue=Oe===Dt?o.SRGB8_ALPHA8:o.RGBA8),G===o.UNSIGNED_SHORT_4_4_4_4&&(ue=o.RGBA4),G===o.UNSIGNED_SHORT_5_5_5_1&&(ue=o.RGB5_A1)}return(ue===o.R16F||ue===o.R32F||ue===o.RG16F||ue===o.RG32F||ue===o.RGBA16F||ue===o.RGBA32F)&&e.get("EXT_color_buffer_float"),ue}function C(I,E){let G;return I?E===null||E===Yi||E===Pa?G=o.DEPTH24_STENCIL8:E===fi?G=o.DEPTH32F_STENCIL8:E===Ca&&(G=o.DEPTH24_STENCIL8,Je("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Yi||E===Pa?G=o.DEPTH_COMPONENT24:E===fi?G=o.DEPTH_COMPONENT32F:E===Ca&&(G=o.DEPTH_COMPONENT16),G}function N(I,E){return y(I)===!0||I.isFramebufferTexture&&I.minFilter!==ln&&I.minFilter!==cn?Math.log2(Math.max(E.width,E.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?E.mipmaps.length:1}function U(I){const E=I.target;E.removeEventListener("dispose",U),w(E),E.isVideoTexture&&g.delete(E)}function k(I){const E=I.target;E.removeEventListener("dispose",k),le(E)}function w(I){const E=i.get(I);if(E.__webglInit===void 0)return;const G=I.source,he=m.get(G);if(he){const me=he[E.__cacheKey];me.usedTimes--,me.usedTimes===0&&P(I),Object.keys(he).length===0&&m.delete(G)}i.remove(I)}function P(I){const E=i.get(I);o.deleteTexture(E.__webglTexture);const G=I.source,he=m.get(G);delete he[E.__cacheKey],c.memory.textures--}function le(I){const E=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let he=0;he<6;he++){if(Array.isArray(E.__webglFramebuffer[he]))for(let me=0;me<E.__webglFramebuffer[he].length;me++)o.deleteFramebuffer(E.__webglFramebuffer[he][me]);else o.deleteFramebuffer(E.__webglFramebuffer[he]);E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer[he])}else{if(Array.isArray(E.__webglFramebuffer))for(let he=0;he<E.__webglFramebuffer.length;he++)o.deleteFramebuffer(E.__webglFramebuffer[he]);else o.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&o.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let he=0;he<E.__webglColorRenderbuffer.length;he++)E.__webglColorRenderbuffer[he]&&o.deleteRenderbuffer(E.__webglColorRenderbuffer[he]);E.__webglDepthRenderbuffer&&o.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const G=I.textures;for(let he=0,me=G.length;he<me;he++){const ue=i.get(G[he]);ue.__webglTexture&&(o.deleteTexture(ue.__webglTexture),c.memory.textures--),i.remove(G[he])}i.remove(I)}let O=0;function J(){O=0}function K(){const I=O;return I>=s.maxTextures&&Je("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+s.maxTextures),O+=1,I}function ae(I){const E=[];return E.push(I.wrapS),E.push(I.wrapT),E.push(I.wrapR||0),E.push(I.magFilter),E.push(I.minFilter),E.push(I.anisotropy),E.push(I.internalFormat),E.push(I.format),E.push(I.type),E.push(I.generateMipmaps),E.push(I.premultiplyAlpha),E.push(I.flipY),E.push(I.unpackAlignment),E.push(I.colorSpace),E.join()}function Q(I,E){const G=i.get(I);if(I.isVideoTexture&&yt(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&G.__version!==I.version){const he=I.image;if(he===null)Je("WebGLRenderer: Texture marked for update but no image data found.");else if(he.complete===!1)Je("WebGLRenderer: Texture marked for update but image is incomplete");else{ie(G,I,E);return}}else I.isExternalTexture&&(G.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(o.TEXTURE_2D,G.__webglTexture,o.TEXTURE0+E)}function te(I,E){const G=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&G.__version!==I.version){ie(G,I,E);return}else I.isExternalTexture&&(G.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(o.TEXTURE_2D_ARRAY,G.__webglTexture,o.TEXTURE0+E)}function W(I,E){const G=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&G.__version!==I.version){ie(G,I,E);return}t.bindTexture(o.TEXTURE_3D,G.__webglTexture,o.TEXTURE0+E)}function $(I,E){const G=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&G.__version!==I.version){pe(G,I,E);return}t.bindTexture(o.TEXTURE_CUBE_MAP,G.__webglTexture,o.TEXTURE0+E)}const oe={[So]:o.REPEAT,[Wi]:o.CLAMP_TO_EDGE,[Pc]:o.MIRRORED_REPEAT},ce={[ln]:o.NEAREST,[B0]:o.NEAREST_MIPMAP_NEAREST,[Ta]:o.NEAREST_MIPMAP_LINEAR,[cn]:o.LINEAR,[Tc]:o.LINEAR_MIPMAP_NEAREST,[pr]:o.LINEAR_MIPMAP_LINEAR},F={[Ox]:o.NEVER,[Hx]:o.ALWAYS,[kx]:o.LESS,[md]:o.LEQUAL,[Bx]:o.EQUAL,[gd]:o.GEQUAL,[zx]:o.GREATER,[Vx]:o.NOTEQUAL};function Y(I,E){if(E.type===fi&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===cn||E.magFilter===Tc||E.magFilter===Ta||E.magFilter===pr||E.minFilter===cn||E.minFilter===Tc||E.minFilter===Ta||E.minFilter===pr)&&Je("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(I,o.TEXTURE_WRAP_S,oe[E.wrapS]),o.texParameteri(I,o.TEXTURE_WRAP_T,oe[E.wrapT]),(I===o.TEXTURE_3D||I===o.TEXTURE_2D_ARRAY)&&o.texParameteri(I,o.TEXTURE_WRAP_R,oe[E.wrapR]),o.texParameteri(I,o.TEXTURE_MAG_FILTER,ce[E.magFilter]),o.texParameteri(I,o.TEXTURE_MIN_FILTER,ce[E.minFilter]),E.compareFunction&&(o.texParameteri(I,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(I,o.TEXTURE_COMPARE_FUNC,F[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===ln||E.minFilter!==Ta&&E.minFilter!==pr||E.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||i.get(E).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");o.texParameterf(I,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,s.getMaxAnisotropy())),i.get(E).__currentAnisotropy=E.anisotropy}}}function Ae(I,E){let G=!1;I.__webglInit===void 0&&(I.__webglInit=!0,E.addEventListener("dispose",U));const he=E.source;let me=m.get(he);me===void 0&&(me={},m.set(he,me));const ue=ae(E);if(ue!==I.__cacheKey){me[ue]===void 0&&(me[ue]={texture:o.createTexture(),usedTimes:0},c.memory.textures++,G=!0),me[ue].usedTimes++;const Oe=me[I.__cacheKey];Oe!==void 0&&(me[I.__cacheKey].usedTimes--,Oe.usedTimes===0&&P(E)),I.__cacheKey=ue,I.__webglTexture=me[ue].texture}return G}function We(I,E,G){return Math.floor(Math.floor(I/G)/E)}function $e(I,E,G,he){const ue=I.updateRanges;if(ue.length===0)t.texSubImage2D(o.TEXTURE_2D,0,0,0,E.width,E.height,G,he,E.data);else{ue.sort((xe,Ee)=>xe.start-Ee.start);let Oe=0;for(let xe=1;xe<ue.length;xe++){const Ee=ue[Oe],Ge=ue[xe],ke=Ee.start+Ee.count,Pe=We(Ge.start,E.width,4),ut=We(Ee.start,E.width,4);Ge.start<=ke+1&&Pe===ut&&We(Ge.start+Ge.count-1,E.width,4)===Pe?Ee.count=Math.max(Ee.count,Ge.start+Ge.count-Ee.start):(++Oe,ue[Oe]=Ge)}ue.length=Oe+1;const Te=o.getParameter(o.UNPACK_ROW_LENGTH),Ye=o.getParameter(o.UNPACK_SKIP_PIXELS),it=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,E.width);for(let xe=0,Ee=ue.length;xe<Ee;xe++){const Ge=ue[xe],ke=Math.floor(Ge.start/4),Pe=Math.ceil(Ge.count/4),ut=ke%E.width,V=Math.floor(ke/E.width),we=Pe,Se=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,ut),o.pixelStorei(o.UNPACK_SKIP_ROWS,V),t.texSubImage2D(o.TEXTURE_2D,0,ut,V,we,Se,G,he,E.data)}I.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Te),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Ye),o.pixelStorei(o.UNPACK_SKIP_ROWS,it)}}function ie(I,E,G){let he=o.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(he=o.TEXTURE_2D_ARRAY),E.isData3DTexture&&(he=o.TEXTURE_3D);const me=Ae(I,E),ue=E.source;t.bindTexture(he,I.__webglTexture,o.TEXTURE0+G);const Oe=i.get(ue);if(ue.version!==Oe.__version||me===!0){t.activeTexture(o.TEXTURE0+G);const Te=Mt.getPrimaries(Mt.workingColorSpace),Ye=E.colorSpace===$r?null:Mt.getPrimaries(E.colorSpace),it=E.colorSpace===$r||Te===Ye?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,it);let xe=A(E.image,!1,s.maxTextureSize);xe=wt(E,xe);const Ee=a.convert(E.format,E.colorSpace),Ge=a.convert(E.type);let ke=L(E.internalFormat,Ee,Ge,E.colorSpace,E.isVideoTexture);Y(he,E);let Pe;const ut=E.mipmaps,V=E.isVideoTexture!==!0,we=Oe.__version===void 0||me===!0,Se=ue.dataReady,Le=N(E,xe);if(E.isDepthTexture)ke=C(E.format===Ms,E.type),we&&(V?t.texStorage2D(o.TEXTURE_2D,1,ke,xe.width,xe.height):t.texImage2D(o.TEXTURE_2D,0,ke,xe.width,xe.height,0,Ee,Ge,null));else if(E.isDataTexture)if(ut.length>0){V&&we&&t.texStorage2D(o.TEXTURE_2D,Le,ke,ut[0].width,ut[0].height);for(let ye=0,fe=ut.length;ye<fe;ye++)Pe=ut[ye],V?Se&&t.texSubImage2D(o.TEXTURE_2D,ye,0,0,Pe.width,Pe.height,Ee,Ge,Pe.data):t.texImage2D(o.TEXTURE_2D,ye,ke,Pe.width,Pe.height,0,Ee,Ge,Pe.data);E.generateMipmaps=!1}else V?(we&&t.texStorage2D(o.TEXTURE_2D,Le,ke,xe.width,xe.height),Se&&$e(E,xe,Ee,Ge)):t.texImage2D(o.TEXTURE_2D,0,ke,xe.width,xe.height,0,Ee,Ge,xe.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){V&&we&&t.texStorage3D(o.TEXTURE_2D_ARRAY,Le,ke,ut[0].width,ut[0].height,xe.depth);for(let ye=0,fe=ut.length;ye<fe;ye++)if(Pe=ut[ye],E.format!==hi)if(Ee!==null)if(V){if(Se)if(E.layerUpdates.size>0){const Be=$g(Pe.width,Pe.height,E.format,E.type);for(const st of E.layerUpdates){const It=Pe.data.subarray(st*Be/Pe.data.BYTES_PER_ELEMENT,(st+1)*Be/Pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,ye,0,0,st,Pe.width,Pe.height,1,Ee,It)}E.clearLayerUpdates()}else t.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,ye,0,0,0,Pe.width,Pe.height,xe.depth,Ee,Pe.data)}else t.compressedTexImage3D(o.TEXTURE_2D_ARRAY,ye,ke,Pe.width,Pe.height,xe.depth,0,Pe.data,0,0);else Je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else V?Se&&t.texSubImage3D(o.TEXTURE_2D_ARRAY,ye,0,0,0,Pe.width,Pe.height,xe.depth,Ee,Ge,Pe.data):t.texImage3D(o.TEXTURE_2D_ARRAY,ye,ke,Pe.width,Pe.height,xe.depth,0,Ee,Ge,Pe.data)}else{V&&we&&t.texStorage2D(o.TEXTURE_2D,Le,ke,ut[0].width,ut[0].height);for(let ye=0,fe=ut.length;ye<fe;ye++)Pe=ut[ye],E.format!==hi?Ee!==null?V?Se&&t.compressedTexSubImage2D(o.TEXTURE_2D,ye,0,0,Pe.width,Pe.height,Ee,Pe.data):t.compressedTexImage2D(o.TEXTURE_2D,ye,ke,Pe.width,Pe.height,0,Pe.data):Je("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):V?Se&&t.texSubImage2D(o.TEXTURE_2D,ye,0,0,Pe.width,Pe.height,Ee,Ge,Pe.data):t.texImage2D(o.TEXTURE_2D,ye,ke,Pe.width,Pe.height,0,Ee,Ge,Pe.data)}else if(E.isDataArrayTexture)if(V){if(we&&t.texStorage3D(o.TEXTURE_2D_ARRAY,Le,ke,xe.width,xe.height,xe.depth),Se)if(E.layerUpdates.size>0){const ye=$g(xe.width,xe.height,E.format,E.type);for(const fe of E.layerUpdates){const Be=xe.data.subarray(fe*ye/xe.data.BYTES_PER_ELEMENT,(fe+1)*ye/xe.data.BYTES_PER_ELEMENT);t.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,fe,xe.width,xe.height,1,Ee,Ge,Be)}E.clearLayerUpdates()}else t.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,xe.width,xe.height,xe.depth,Ee,Ge,xe.data)}else t.texImage3D(o.TEXTURE_2D_ARRAY,0,ke,xe.width,xe.height,xe.depth,0,Ee,Ge,xe.data);else if(E.isData3DTexture)V?(we&&t.texStorage3D(o.TEXTURE_3D,Le,ke,xe.width,xe.height,xe.depth),Se&&t.texSubImage3D(o.TEXTURE_3D,0,0,0,0,xe.width,xe.height,xe.depth,Ee,Ge,xe.data)):t.texImage3D(o.TEXTURE_3D,0,ke,xe.width,xe.height,xe.depth,0,Ee,Ge,xe.data);else if(E.isFramebufferTexture){if(we)if(V)t.texStorage2D(o.TEXTURE_2D,Le,ke,xe.width,xe.height);else{let ye=xe.width,fe=xe.height;for(let Be=0;Be<Le;Be++)t.texImage2D(o.TEXTURE_2D,Be,ke,ye,fe,0,Ee,Ge,null),ye>>=1,fe>>=1}}else if(ut.length>0){if(V&&we){const ye=He(ut[0]);t.texStorage2D(o.TEXTURE_2D,Le,ke,ye.width,ye.height)}for(let ye=0,fe=ut.length;ye<fe;ye++)Pe=ut[ye],V?Se&&t.texSubImage2D(o.TEXTURE_2D,ye,0,0,Ee,Ge,Pe):t.texImage2D(o.TEXTURE_2D,ye,ke,Ee,Ge,Pe);E.generateMipmaps=!1}else if(V){if(we){const ye=He(xe);t.texStorage2D(o.TEXTURE_2D,Le,ke,ye.width,ye.height)}Se&&t.texSubImage2D(o.TEXTURE_2D,0,0,0,Ee,Ge,xe)}else t.texImage2D(o.TEXTURE_2D,0,ke,Ee,Ge,xe);y(E)&&S(he),Oe.__version=ue.version,E.onUpdate&&E.onUpdate(E)}I.__version=E.version}function pe(I,E,G){if(E.image.length!==6)return;const he=Ae(I,E),me=E.source;t.bindTexture(o.TEXTURE_CUBE_MAP,I.__webglTexture,o.TEXTURE0+G);const ue=i.get(me);if(me.version!==ue.__version||he===!0){t.activeTexture(o.TEXTURE0+G);const Oe=Mt.getPrimaries(Mt.workingColorSpace),Te=E.colorSpace===$r?null:Mt.getPrimaries(E.colorSpace),Ye=E.colorSpace===$r||Oe===Te?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);const it=E.isCompressedTexture||E.image[0].isCompressedTexture,xe=E.image[0]&&E.image[0].isDataTexture,Ee=[];for(let fe=0;fe<6;fe++)!it&&!xe?Ee[fe]=A(E.image[fe],!0,s.maxCubemapSize):Ee[fe]=xe?E.image[fe].image:E.image[fe],Ee[fe]=wt(E,Ee[fe]);const Ge=Ee[0],ke=a.convert(E.format,E.colorSpace),Pe=a.convert(E.type),ut=L(E.internalFormat,ke,Pe,E.colorSpace),V=E.isVideoTexture!==!0,we=ue.__version===void 0||he===!0,Se=me.dataReady;let Le=N(E,Ge);Y(o.TEXTURE_CUBE_MAP,E);let ye;if(it){V&&we&&t.texStorage2D(o.TEXTURE_CUBE_MAP,Le,ut,Ge.width,Ge.height);for(let fe=0;fe<6;fe++){ye=Ee[fe].mipmaps;for(let Be=0;Be<ye.length;Be++){const st=ye[Be];E.format!==hi?ke!==null?V?Se&&t.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be,0,0,st.width,st.height,ke,st.data):t.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be,ut,st.width,st.height,0,st.data):Je("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):V?Se&&t.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be,0,0,st.width,st.height,ke,Pe,st.data):t.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be,ut,st.width,st.height,0,ke,Pe,st.data)}}}else{if(ye=E.mipmaps,V&&we){ye.length>0&&Le++;const fe=He(Ee[0]);t.texStorage2D(o.TEXTURE_CUBE_MAP,Le,ut,fe.width,fe.height)}for(let fe=0;fe<6;fe++)if(xe){V?Se&&t.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,Ee[fe].width,Ee[fe].height,ke,Pe,Ee[fe].data):t.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,ut,Ee[fe].width,Ee[fe].height,0,ke,Pe,Ee[fe].data);for(let Be=0;Be<ye.length;Be++){const It=ye[Be].image[fe].image;V?Se&&t.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be+1,0,0,It.width,It.height,ke,Pe,It.data):t.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be+1,ut,It.width,It.height,0,ke,Pe,It.data)}}else{V?Se&&t.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,ke,Pe,Ee[fe]):t.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,ut,ke,Pe,Ee[fe]);for(let Be=0;Be<ye.length;Be++){const st=ye[Be];V?Se&&t.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be+1,0,0,ke,Pe,st.image[fe]):t.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+fe,Be+1,ut,ke,Pe,st.image[fe])}}}y(E)&&S(o.TEXTURE_CUBE_MAP),ue.__version=me.version,E.onUpdate&&E.onUpdate(E)}I.__version=E.version}function de(I,E,G,he,me,ue){const Oe=a.convert(G.format,G.colorSpace),Te=a.convert(G.type),Ye=L(G.internalFormat,Oe,Te,G.colorSpace),it=i.get(E),xe=i.get(G);if(xe.__renderTarget=E,!it.__hasExternalTextures){const Ee=Math.max(1,E.width>>ue),Ge=Math.max(1,E.height>>ue);me===o.TEXTURE_3D||me===o.TEXTURE_2D_ARRAY?t.texImage3D(me,ue,Ye,Ee,Ge,E.depth,0,Oe,Te,null):t.texImage2D(me,ue,Ye,Ee,Ge,0,Oe,Te,null)}t.bindFramebuffer(o.FRAMEBUFFER,I),Xt(E)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,he,me,xe.__webglTexture,0,z(E)):(me===o.TEXTURE_2D||me>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&me<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,he,me,xe.__webglTexture,ue),t.bindFramebuffer(o.FRAMEBUFFER,null)}function Ue(I,E,G){if(o.bindRenderbuffer(o.RENDERBUFFER,I),E.depthBuffer){const he=E.depthTexture,me=he&&he.isDepthTexture?he.type:null,ue=C(E.stencilBuffer,me),Oe=E.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;Xt(E)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,z(E),ue,E.width,E.height):G?o.renderbufferStorageMultisample(o.RENDERBUFFER,z(E),ue,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,ue,E.width,E.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Oe,o.RENDERBUFFER,I)}else{const he=E.textures;for(let me=0;me<he.length;me++){const ue=he[me],Oe=a.convert(ue.format,ue.colorSpace),Te=a.convert(ue.type),Ye=L(ue.internalFormat,Oe,Te,ue.colorSpace);Xt(E)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,z(E),Ye,E.width,E.height):G?o.renderbufferStorageMultisample(o.RENDERBUFFER,z(E),Ye,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,Ye,E.width,E.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Ve(I,E,G){const he=E.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(o.FRAMEBUFFER,I),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const me=i.get(E.depthTexture);if(me.__renderTarget=E,(!me.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),he){if(me.__webglInit===void 0&&(me.__webglInit=!0,E.depthTexture.addEventListener("dispose",U)),me.__webglTexture===void 0){me.__webglTexture=o.createTexture(),t.bindTexture(o.TEXTURE_CUBE_MAP,me.__webglTexture),Y(o.TEXTURE_CUBE_MAP,E.depthTexture);const it=a.convert(E.depthTexture.format),xe=a.convert(E.depthTexture.type);let Ee;E.depthTexture.format===yr?Ee=o.DEPTH_COMPONENT24:E.depthTexture.format===Ms&&(Ee=o.DEPTH24_STENCIL8);for(let Ge=0;Ge<6;Ge++)o.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Ge,0,Ee,E.width,E.height,0,it,xe,null)}}else Q(E.depthTexture,0);const ue=me.__webglTexture,Oe=z(E),Te=he?o.TEXTURE_CUBE_MAP_POSITIVE_X+G:o.TEXTURE_2D,Ye=E.depthTexture.format===Ms?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;if(E.depthTexture.format===yr)Xt(E)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Ye,Te,ue,0,Oe):o.framebufferTexture2D(o.FRAMEBUFFER,Ye,Te,ue,0);else if(E.depthTexture.format===Ms)Xt(E)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Ye,Te,ue,0,Oe):o.framebufferTexture2D(o.FRAMEBUFFER,Ye,Te,ue,0);else throw new Error("Unknown depthTexture format")}function nt(I){const E=i.get(I),G=I.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==I.depthTexture){const he=I.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),he){const me=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,he.removeEventListener("dispose",me)};he.addEventListener("dispose",me),E.__depthDisposeCallback=me}E.__boundDepthTexture=he}if(I.depthTexture&&!E.__autoAllocateDepthBuffer)if(G)for(let he=0;he<6;he++)Ve(E.__webglFramebuffer[he],I,he);else{const he=I.texture.mipmaps;he&&he.length>0?Ve(E.__webglFramebuffer[0],I,0):Ve(E.__webglFramebuffer,I,0)}else if(G){E.__webglDepthbuffer=[];for(let he=0;he<6;he++)if(t.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[he]),E.__webglDepthbuffer[he]===void 0)E.__webglDepthbuffer[he]=o.createRenderbuffer(),Ue(E.__webglDepthbuffer[he],I,!1);else{const me=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ue=E.__webglDepthbuffer[he];o.bindRenderbuffer(o.RENDERBUFFER,ue),o.framebufferRenderbuffer(o.FRAMEBUFFER,me,o.RENDERBUFFER,ue)}}else{const he=I.texture.mipmaps;if(he&&he.length>0?t.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[0]):t.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=o.createRenderbuffer(),Ue(E.__webglDepthbuffer,I,!1);else{const me=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ue=E.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ue),o.framebufferRenderbuffer(o.FRAMEBUFFER,me,o.RENDERBUFFER,ue)}}t.bindFramebuffer(o.FRAMEBUFFER,null)}function Zt(I,E,G){const he=i.get(I);E!==void 0&&de(he.__webglFramebuffer,I,I.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),G!==void 0&&nt(I)}function _t(I){const E=I.texture,G=i.get(I),he=i.get(E);I.addEventListener("dispose",k);const me=I.textures,ue=I.isWebGLCubeRenderTarget===!0,Oe=me.length>1;if(Oe||(he.__webglTexture===void 0&&(he.__webglTexture=o.createTexture()),he.__version=E.version,c.memory.textures++),ue){G.__webglFramebuffer=[];for(let Te=0;Te<6;Te++)if(E.mipmaps&&E.mipmaps.length>0){G.__webglFramebuffer[Te]=[];for(let Ye=0;Ye<E.mipmaps.length;Ye++)G.__webglFramebuffer[Te][Ye]=o.createFramebuffer()}else G.__webglFramebuffer[Te]=o.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){G.__webglFramebuffer=[];for(let Te=0;Te<E.mipmaps.length;Te++)G.__webglFramebuffer[Te]=o.createFramebuffer()}else G.__webglFramebuffer=o.createFramebuffer();if(Oe)for(let Te=0,Ye=me.length;Te<Ye;Te++){const it=i.get(me[Te]);it.__webglTexture===void 0&&(it.__webglTexture=o.createTexture(),c.memory.textures++)}if(I.samples>0&&Xt(I)===!1){G.__webglMultisampledFramebuffer=o.createFramebuffer(),G.__webglColorRenderbuffer=[],t.bindFramebuffer(o.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let Te=0;Te<me.length;Te++){const Ye=me[Te];G.__webglColorRenderbuffer[Te]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,G.__webglColorRenderbuffer[Te]);const it=a.convert(Ye.format,Ye.colorSpace),xe=a.convert(Ye.type),Ee=L(Ye.internalFormat,it,xe,Ye.colorSpace,I.isXRRenderTarget===!0),Ge=z(I);o.renderbufferStorageMultisample(o.RENDERBUFFER,Ge,Ee,I.width,I.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Te,o.RENDERBUFFER,G.__webglColorRenderbuffer[Te])}o.bindRenderbuffer(o.RENDERBUFFER,null),I.depthBuffer&&(G.__webglDepthRenderbuffer=o.createRenderbuffer(),Ue(G.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ue){t.bindTexture(o.TEXTURE_CUBE_MAP,he.__webglTexture),Y(o.TEXTURE_CUBE_MAP,E);for(let Te=0;Te<6;Te++)if(E.mipmaps&&E.mipmaps.length>0)for(let Ye=0;Ye<E.mipmaps.length;Ye++)de(G.__webglFramebuffer[Te][Ye],I,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Te,Ye);else de(G.__webglFramebuffer[Te],I,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Te,0);y(E)&&S(o.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Oe){for(let Te=0,Ye=me.length;Te<Ye;Te++){const it=me[Te],xe=i.get(it);let Ee=o.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Ee=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),t.bindTexture(Ee,xe.__webglTexture),Y(Ee,it),de(G.__webglFramebuffer,I,it,o.COLOR_ATTACHMENT0+Te,Ee,0),y(it)&&S(Ee)}t.unbindTexture()}else{let Te=o.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Te=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),t.bindTexture(Te,he.__webglTexture),Y(Te,E),E.mipmaps&&E.mipmaps.length>0)for(let Ye=0;Ye<E.mipmaps.length;Ye++)de(G.__webglFramebuffer[Ye],I,E,o.COLOR_ATTACHMENT0,Te,Ye);else de(G.__webglFramebuffer,I,E,o.COLOR_ATTACHMENT0,Te,0);y(E)&&S(Te),t.unbindTexture()}I.depthBuffer&&nt(I)}function Tt(I){const E=I.textures;for(let G=0,he=E.length;G<he;G++){const me=E[G];if(y(me)){const ue=R(I),Oe=i.get(me).__webglTexture;t.bindTexture(ue,Oe),S(ue),t.unbindTexture()}}}const Pt=[],ft=[];function Vt(I){if(I.samples>0){if(Xt(I)===!1){const E=I.textures,G=I.width,he=I.height;let me=o.COLOR_BUFFER_BIT;const ue=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Oe=i.get(I),Te=E.length>1;if(Te)for(let it=0;it<E.length;it++)t.bindFramebuffer(o.FRAMEBUFFER,Oe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+it,o.RENDERBUFFER,null),t.bindFramebuffer(o.FRAMEBUFFER,Oe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+it,o.TEXTURE_2D,null,0);t.bindFramebuffer(o.READ_FRAMEBUFFER,Oe.__webglMultisampledFramebuffer);const Ye=I.texture.mipmaps;Ye&&Ye.length>0?t.bindFramebuffer(o.DRAW_FRAMEBUFFER,Oe.__webglFramebuffer[0]):t.bindFramebuffer(o.DRAW_FRAMEBUFFER,Oe.__webglFramebuffer);for(let it=0;it<E.length;it++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(me|=o.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(me|=o.STENCIL_BUFFER_BIT)),Te){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Oe.__webglColorRenderbuffer[it]);const xe=i.get(E[it]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,xe,0)}o.blitFramebuffer(0,0,G,he,0,0,G,he,me,o.NEAREST),h===!0&&(Pt.length=0,ft.length=0,Pt.push(o.COLOR_ATTACHMENT0+it),I.depthBuffer&&I.resolveDepthBuffer===!1&&(Pt.push(ue),ft.push(ue),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ft)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,Pt))}if(t.bindFramebuffer(o.READ_FRAMEBUFFER,null),t.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Te)for(let it=0;it<E.length;it++){t.bindFramebuffer(o.FRAMEBUFFER,Oe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+it,o.RENDERBUFFER,Oe.__webglColorRenderbuffer[it]);const xe=i.get(E[it]).__webglTexture;t.bindFramebuffer(o.FRAMEBUFFER,Oe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+it,o.TEXTURE_2D,xe,0)}t.bindFramebuffer(o.DRAW_FRAMEBUFFER,Oe.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&h){const E=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[E])}}}function z(I){return Math.min(s.maxSamples,I.samples)}function Xt(I){const E=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function yt(I){const E=c.render.frame;g.get(I)!==E&&(g.set(I,E),I.update())}function wt(I,E){const G=I.colorSpace,he=I.format,me=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||G!==Dn&&G!==$r&&(Mt.getTransfer(G)===Dt?(he!==hi||me!==Qn)&&Je("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rt("WebGLTextures: Unsupported texture color space:",G)),E}function He(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(d.width=I.naturalWidth||I.width,d.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(d.width=I.displayWidth,d.height=I.displayHeight):(d.width=I.width,d.height=I.height),d}this.allocateTextureUnit=K,this.resetTextureUnits=J,this.setTexture2D=Q,this.setTexture2DArray=te,this.setTexture3D=W,this.setTextureCube=$,this.rebindTextures=Zt,this.setupRenderTarget=_t,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=Vt,this.setupDepthRenderbuffer=nt,this.setupFrameBufferTexture=de,this.useMultisampledRTT=Xt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function hw(o,e){function t(i,s=$r){let a;const c=Mt.getTransfer(s);if(i===Qn)return o.UNSIGNED_BYTE;if(i===cd)return o.UNSIGNED_SHORT_4_4_4_4;if(i===ud)return o.UNSIGNED_SHORT_5_5_5_1;if(i===H0)return o.UNSIGNED_INT_5_9_9_9_REV;if(i===G0)return o.UNSIGNED_INT_10F_11F_11F_REV;if(i===z0)return o.BYTE;if(i===V0)return o.SHORT;if(i===Ca)return o.UNSIGNED_SHORT;if(i===ld)return o.INT;if(i===Yi)return o.UNSIGNED_INT;if(i===fi)return o.FLOAT;if(i===xr)return o.HALF_FLOAT;if(i===W0)return o.ALPHA;if(i===X0)return o.RGB;if(i===hi)return o.RGBA;if(i===yr)return o.DEPTH_COMPONENT;if(i===Ms)return o.DEPTH_STENCIL;if(i===fd)return o.RED;if(i===hd)return o.RED_INTEGER;if(i===Mo)return o.RG;if(i===dd)return o.RG_INTEGER;if(i===pd)return o.RGBA_INTEGER;if(i===wc||i===Ac||i===bc||i===Rc)if(c===Dt)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===wc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Ac)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===bc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Rc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===wc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Ac)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===bc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Rc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===xh||i===yh||i===Sh||i===Mh)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===xh)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===yh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Sh)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Mh)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Eh||i===Th||i===wh||i===Ah||i===bh||i===Rh||i===Ch)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Eh||i===Th)return c===Dt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===wh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ah)return a.COMPRESSED_R11_EAC;if(i===bh)return a.COMPRESSED_SIGNED_R11_EAC;if(i===Rh)return a.COMPRESSED_RG11_EAC;if(i===Ch)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ph||i===Lh||i===Ih||i===Dh||i===Nh||i===Uh||i===Fh||i===Oh||i===kh||i===Bh||i===zh||i===Vh||i===Hh||i===Gh)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Ph)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Lh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ih)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Dh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Nh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Uh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Fh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Oh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===kh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Bh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===zh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Vh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Hh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Gh)return c===Dt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Wh||i===Xh||i===jh)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(i===Wh)return c===Dt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Xh)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===jh)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Yh||i===qh||i===Kh||i===$h)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(i===Yh)return a.COMPRESSED_RED_RGTC1_EXT;if(i===qh)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Kh)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===$h)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Pa?o.UNSIGNED_INT_24_8:o[i]!==void 0?o[i]:null}return{convert:t}}const dw=`
void main() {
